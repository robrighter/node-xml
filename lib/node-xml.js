...
SAXDriver.prototype.parse = function(strD) {
    ...
    setTimeout(function(){
            ...
            if(!that.m_bErr) {
                that._fireEvent(SAXDriver.DOC_B);
            }
            that._parseLoop();
            if(!that.m_bErr) {
                that._fireEvent(SAXDriver.DOC_E);
            }
...
SAXDriver.prototype.pause = function() {
    this.m_parser.pause();
}

SAXDriver.prototype.resume = function() {
    //reset the state
...
SAXDriver.prototype._parseLoop = function(parser) {
    ...
    while(!this.m_bErr) {
        ...
        if(iEvent == XMLP._ELM_B) {
            this._fireEvent(SAXDriver.ELM_B, parser.getName(), this.m_parser.m_atts.map(function(item){return { name : item[0], value : item[1], };}) );
        }
